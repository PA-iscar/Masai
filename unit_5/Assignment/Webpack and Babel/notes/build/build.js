(() => {
  ...
  (r.n = (e) => {
    ...
    (() => {
      ...
      const m = r.p + "3c38fb23c581f31081f0557467a47ee1.png";
      document.querySelector("img").src = m;
      const h = document.body.querySelector("form"),
        y = h.querySelector("#input");
      h.addEventListener("submit", (e) => {
        e.preventDefault();
        let t = document.body.querySelector("#notes"),
          r = document.createElement("div");
        r.classList.add("note"), (r.textContent = y.value), t.append(r);
      });
    })();
})();
